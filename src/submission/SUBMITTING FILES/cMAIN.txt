...
// removeStudent takes all of the 4 lists and the head and does the following:
// Queries the user for which course they want to remove the student from,
// Searches the relevant array for the student,
// Queries a removal confirmation,
// Removes the student.
// It then creates a new linked list.
...
// Pass all of the course arrays and the head to this function and it will do the following:
// Create a list of all students,
// Merge Sort the list of all students,
...
// Merge is a required sub-function of Merge Sort, pass it the array, start, middle, and end indices.
...
// Pass Merge Sort the array, and start and end indices.
...
// Pass searchStudent() the head and a string to search for.
...
// Pass printLinkedList() the head and it will print the names of everyone in the linked list.
...
// Pass findFullTime() the head and it will print the information of everyone in a full-time course.
